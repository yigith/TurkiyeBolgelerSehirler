...
namespace TurkiyeBolgelerSehirler.Data
{
    public class UygulamaDbContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<Bolge>().HasData(BolgelerDizisi());
            modelBuilder.Entity<Sehir>().HasData(SehirlerDizisi());
        }

        Bolge[] BolgelerDizisi()
        {
            var bolgeler = new Bolge[]
            {
